...
class SoundElement:
    ...
    def get_cpp(self, next_name=None, tab_index=0):
        ...
        return f"""static const PROGMEM SoundElement {self.name} = 
...
class SoundSequence:
    ...
    def get_cpp(self, tab_index=0):
        return f"""const PROGMEM SoundSequence {self.name} = 
{" " * (TAB_SIZE * tab_index + 0)}{{
...
"""
    ...
    def render_header(self):
        return f"extern const PROGMEM SoundSequence {self.name};\n"
...
def main():
    ...
    with open("./include/sounds.h", "w") as f:
        f.write(f"// Autogenerated.  Takes {flash_size:,} bytes of flash\n")
        f.write("\n")
